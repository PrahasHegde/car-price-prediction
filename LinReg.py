...
print(lr_mae) # 2891.3739057538883

lr_r2 = r2_score(y_test, lr_prediction)
print(lr_r2) # 0.8124290725000003


fig = px.scatter(x=y_test, y=lr_prediction, labels={'x': 'Actual Price', 'y': 'Predicted Price'}, title='Linear Regression Model Prediction')
fig.show()
