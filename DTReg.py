...
print(dtr_mae) # 2058.731707317073

dtr_r2 = r2_score(y_test, dtr_prediction)
print(dtr_r2)# 0.9083297403801555

#scatter plot for actual vs predicted price

fig = px.scatter(x=y_test, y=dtr_prediction, labels={'x': 'Actual Price', 'y': 'Predicted Price'}, title='Decision Tree Regressor Model Prediction')
fig.show()
