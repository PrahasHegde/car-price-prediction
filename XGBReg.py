...
#metrics
xgbr_mae = mean_absolute_error(y_test, xgbr_prediction)
print(xgbr_mae) # 1636.5274747522865

xgbr_r2 = r2_score(y_test, xgbr_prediction)
print(xgbr_r2 )# 0.9343254539853002


fig = px.scatter(x=y_test, y=xgbr_prediction, labels={'x': 'Actual Price', 'y': 'Predicted Price'}, title='XGB Regressor Model Prediction')
fig.show()
